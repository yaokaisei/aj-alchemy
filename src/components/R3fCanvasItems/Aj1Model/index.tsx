...
/** glbファイルのパス */
const MODEL_PATH = '/aj-alchemy/gltf/model_air-jordan-1.glb';

interface Aj1ModelProps extends GroupProps {
  clickZooom?: boolean;
}

export const Aj1Model: React.FC<Aj1ModelProps> = ({
  clickZooom = true,
  ...props
}): JSX.Element => {
  ...
  return (
    <group {...props} dispose={null}>
      <SelectToZoom isZoom={clickZooom}>
        <>
          <mesh
